...
export default function ProjectPage({ params }) {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-[#f5f5f7] dark:bg-gradient-to-br dark:from-[#0a0a0a] dark:via-[#121212] dark:to-[#1a1a1a] flex items-center justify-center">
        <div className="text-[#1d1d1f] dark:text-white text-xl">Loading...</div>
      </div>
    );
  }
  ...
  if (!projectData) {
    return (
      <div className="min-h-screen bg-[#f5f5f7] dark:bg-gradient-to-br dark:from-[#0a0a0a] dark:via-[#121212] dark:to-[#1a1a1a] flex items-center justify-center">
        <div className="text-[#1d1d1f] dark:text-white text-xl">Project not found</div>
      </div>
    );
  }
