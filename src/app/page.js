...
export default async function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-col bg-[#f5f5f7] dark:bg-gradient-to-br dark:from-[#0a0a0a] dark:via-[#121212] dark:to-[#1a1a1a] relative overflow-x-hidden">
      ...
      <div className="relative z-10">
        ...
        <section className="py-20 md:py-28 lg:py-32 relative">
          <div className="absolute inset-0 bg-gradient-to-r from-transparent via-black/[0.02] dark:via-white/[0.02] to-transparent" />
        ...
        <section className="py-20 md:py-28 lg:py-32 relative">
          <div className="absolute inset-0 bg-gradient-to-b from-transparent via-black/[0.01] dark:via-white/[0.01] to-transparent" />
          <div className="max-w-7xl mx-auto px-6 md:px-8 lg:px-12 relative z-10">
            <AboutSection />
          </div>
        </section>
